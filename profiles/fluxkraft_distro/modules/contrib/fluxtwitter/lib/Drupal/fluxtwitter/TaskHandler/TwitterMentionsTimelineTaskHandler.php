...
/**
 * @file
 * Contains TwitterMentionsTimelineTaskHandler.
 */
 ...
 */
class TwitterMentionsTimelineTaskHandler extends TwitterTaskHandlerBase {
  ...
  public function runTask() {
    ...
    $store = fluxservice_key_value('fluxtwitter.timeline.mentions');
    ...
    if ($tweets = $account->client()->getMentionsTimeline($arguments)) {
