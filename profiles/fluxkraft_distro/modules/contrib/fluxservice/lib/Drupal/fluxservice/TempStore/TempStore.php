...
namespace Drupal\fluxservice\TempStore;

use Drupal\fluxservice\KeyValueStore\KeyValueStoreExpirableInterface;
...
class TempStore {
   ...
   *
   * @var \Drupal\fluxservice\KeyValueStore\KeyValueStoreExpirableInterface;
   */
  protected $storage;
   ...
   *   The owner key to store along with the data (e.g. a user or session ID).
   */
  function __construct(KeyValueStoreExpirableInterface $storage, $owner) {
   ...
   * Retrieves a value from this TempStore for a given key.
   *
   * Only returns the value if the value is owned by $this->owner.Zz
   *
   * @param string $key
   *   The key of the data to retrieve.
   *
   ...
   * Stores a particular key/value pair in this TempStore.
   *
   * Only stores the given key/value pair if it does not exist yet or the
   * owner of the existing key/value pair is the same as $this->owner.
   *
   * @param string $key
   *   The key of the data to store.
   * @param mixed $value
